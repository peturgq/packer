...
sudo wget http://46.149.18.253/scripts/ubuntu/hostname -O /etc/dhcp/dhclient-exit-hooks.d/hostname
sudo wget http://46.149.18.253/scripts/ubuntu/gq-create-ssh-keys.conf -O /etc/init/gq-create-ssh-keys.conf
sudo wget http://46.149.18.253/scripts/ubuntu/gq-get-password.conf -O /etc/init/gq-get-password.conf
sudo wget http://46.149.18.253/scripts/ubuntu/gq-get-ssh-keys.conf -O /etc/init/gq-get-ssh-keys.conf
sudo wget http://46.149.18.253/scripts/ubuntu/gq-get-userdata.conf -O /etc/init/gq-get-userdata.conf

sudo wget http://46.149.18.253/scripts/ubuntu/gq-get-passwd -O /etc/init.d/gq-get-passwd
sudo wget http://46.149.18.253/scripts/ubuntu/init.d/gq-get-ssh-keys -O /etc/init.d/gq-get-ssh-keys

if not exist "C:\Windows\Temp\7z920-x64.msi" (
	powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://images.qstack.com/win/7z938-x64.msi', 'C:\Windows\Temp\7z938-x64.msi')" <NUL
)
msiexec /qb /i C:\Windows\Temp\7z938-x64.msi

if not exist "C:\Windows\Temp\ultradefrag.zip" (
	powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://images.qstack.com/win/ultradefrag-portable-6.1.0.bin.amd64.zip', 'C:\Windows\Temp\ultradefrag.zip')" <NUL
)
...
if not exist "C:\Windows\Temp\SDelete.zip" (
  powershell -Command "(New-Object System.Net.WebClient).DownloadFile('http://images.qstack.com/win/SDelete.zip', 'C:\Windows\Temp\SDelete.zip')" <NUL
)
